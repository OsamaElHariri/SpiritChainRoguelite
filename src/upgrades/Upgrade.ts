...
export class UpgradeUtil {
    ...
    static readonly upgrades: Upgrade[] = [
        ...
        { id: 'weapon_increase_speed', cost: 4, weaponUpgrade: PowerUp.doubleStrength, description: "Your spirit weapon deals more damage" },
        ...
        { id: 'fist_pulse_count_increase', cost: 2, punchUpgrade: MeleePowerUp.increasePulseExplosionCount, description: "Spirit punch emits a pulse" },
        { id: 'fist_pulse_count_increase_again', cost: 4, punchUpgrade: MeleePowerUp.increasePulseExplosionCount, description: "Spirit punch emits another pulse" },
